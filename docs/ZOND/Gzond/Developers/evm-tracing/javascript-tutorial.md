...
id: go-zond-evm-tracing-js-tracing
hide_title: false
hide_table_of_contents: true
displayed_sidebar: gzondSidebar
sidebar_label: Javascript Tracing
sidebar_position: 6
pagination_label: Javascript Tracing
custom_edit_url: https://github.com/theqrl/documentation/edit/main/docs/getting-started.md
keywords:
  - docs
image: /assets/img/icons/yellow.png
slug: /gzond/dev/evm-tracing/js-tracing
---

Gzond supports tracing via [custom Javascript tracers](/docs/developers/evm-tracing/custom-tracer#custom-javascript-tracing). This document provides a tutorial with examples on how to achieve this.
...
1. Run the [JavaScript console](/docs/interacting-with-gzond/javascript-console).
...
The trace above reports the program counter (PC) and whquanta the program read from storage or wrote to it. That alone isn't particularly useful. To know more, the `log.stack.peek` function can be used to peek into the stack. `log.stack.peek(0)` is the stack top, `log.stack.peek(1)` the entry below it, etc.
...
However, `log.contract.getAddress()` returns an array of bytes. To convert this to the familiar hexadecimal representation of Zond addresses, `this.byteHex()` and `array2Hex()` can be used.
