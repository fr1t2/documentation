...
id: go-zond-tools-clef-apis
hide_title: false
hide_table_of_contents: true
displayed_sidebar: gzondSidebar
sidebar_label: Clef APIs
sidebar_position: 4
pagination_label: Clef APIs
custom_edit_url: https://github.com/theqrl/documentation/edit/main/docs/getting-started.md
keywords:
  - docs
image: /assets/img/icons/yellow.png
slug: /gzond/tools/clef/apis
---
...
See the [external API changelog](https://github.com/zond/go-zond/blob/master/cmd/clef/extapi_changelog.md) for up to date information about changes to this API.
...
1. transaction object (legacy):
   ...
   - `value` [number:optional]: amount of Shor to send with the transaction
...
- content type [string]: type of signed data
  ...
  - `application/clique`: [clique](https://github.com/zond/EIPs/issues/225) headers
...
Signs a chunk of structured data conformant to [EIP-712](https://github.com/zond/EIPs/blob/master/EIPS/eip-712.md) and returns the calculated signature.
...
An example (insecure) proof-of-concept external UI has been implemented in [`pythonsigner.py`](https://github.com/zond/go-zond/blob/master/cmd/clef/pythonsigner.py).
...
See the [ui API changelog](https://github.com/zond/go-zond/blob/master/cmd/clef/intapi_changelog.md) for information about changes to this API.
