...
id: go-zond-tools-abigeen
hide_title: false
hide_table_of_contents: true
displayed_sidebar: gzondSidebar
sidebar_label: Abigen
sidebar_position: 1
pagination_label: Abigen
custom_edit_url: https://github.com/theqrl/documentation/edit/main/docs/getting-started.md
keywords:
  - docs
image: /assets/img/icons/yellow.png
slug: /gzond/tools/abigen
---

Abigen is a binding-generator for easily interacting with Zond using Go. Abigen creates easy-to-use, type-safe Go packages from Zond smart contract definitions known as ABIs. This abstracts away a lot of the complexity of handling smart contract deployment and interaction in Go native applications such as encoding and decoding smart contracts into EVM bytecode. Abigen comes bundled with Gzond. A full Gzond installation includes the abigen binary. Abigen can also be built independently by running the below `go install` command:
...
For instructions on how to deploy this contract to Zond from a Go native application read our [Go bindings page](/docs/developers/dapp-developer/native). To browse the Abigen source code visit the Gzond [GitHub repository](https://github.com/zond/go-zond/tree/master/cmd/abigen).
