<table>
    <tbody>
      ...
      <tr>
        ...
        <td>
        <ul> 
          <li>Contributes to the security of Zond's ecosystem.</li>    
          <li>Lets you access the Zond network directly without having to trust a third party service.</li> 
        </ul> 
        </td>
        <td>
          <ul> 
      ...
      <tr>
          ...
          <td>
          <ul>
            <li>Lets you stake ZOND, propose + validate blocks, earn staking rewards + transaction fee tips.</li>
          </ul>
          </td>
          <td>
            <ul> 
              ...
              <li><strong>32 ZOND</strong> (Mainnet)</li>
              <li><strong>32 testnet ZOND</strong> (Testnets)</li> 
            </ul> 
          </td>
      </tr>
    </tbody>
...
- **If you're staking ZOND as a validator, try this guide on a testnet first**, *then* mainnet.
...
- **Join the community** - join our [mailing list](https://groups.google.com/g/qrysm-dev), the [Qrysm Discord server](https://theqrl.org/discord), [r/zondstaker](https://www.reddit.com/r/zondstaker/), and the [EthStaker Discord server](https://discord.gg/zondstaker) for updates and support.
