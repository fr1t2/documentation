...
- Connection to a synced [QRL Node](../../qrl/use/node/overview) (*remote or local*)
...
See the [Node Configuration documentation](../../qrl/use/node/config) for more information for setting port numbers for your QRL Node. Additional network settings and configuration may be needed to reach a node and is outside the scope of this document. 
