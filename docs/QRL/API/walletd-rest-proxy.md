...
slug: /qrl/api/walletd-rest-proxy
---
...
overridden. See the [node configuration documentation](../../qrl/use/node/config) for information on setting these to a different port in your local node.
...
:::tip
The `qrl_walletd` API is installed with the base [QRL Node](../../qrl/use/node). Follow [this guide](../../qrl/use/node/installation) to install the tools and get started.
:::
...
:::tip
This function can be used to [notarize](../../qrl/use/tools/notarize) data or for any free form data. 
See the [message encoding](./qrl/build/messages/message-tx-encoding) documentation for information on established encoding formats. 
:::
...
:::tip
This function can be used to [notarize](../../qrl/use/tools/notarize/overview) data or for as any free form data. 
See the [message encoding](./qrl/build/messages/message-tx-encoding) documentation for information on established encoding formats. 
:::
...
:::info
More information can be found in the [QRL Token Documentation](../../qrl/use/tools/tokens/)
:::
