...
slug: /qrl/build/mining/qrl-pool-setup
---
...
Follow the instructions found at [docs.theqrl.org/node/QRLnode/](../../../qrl/use/node/overview) to get the node started.
...
With the encrypted QRL Wallet.json file can create a slave tree file. This file contains a new set of [One Time Signatures *(OTS)*](../../../qrl/build/fundamentals/ots-keys) generated from the main address that the pool will use to send transactions. See more on the XMSS slave trees in our [Documentation](../../../qrl/use/node/node-cli/node-cli-slave-xmss)
