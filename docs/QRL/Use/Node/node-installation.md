...
slug: /qrl/use/node/installation
---
...
There are some basic requirements that must be met to run a QRL node. See the [QRL Node Requirements](../../../qrl/use/node/requirements) documentation for more info.
:::
