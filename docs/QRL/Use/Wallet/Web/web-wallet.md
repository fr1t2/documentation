...
slug: /qrl/use/wallet/web/overview
---
...
When you create a new wallet you create an XMSS tree, which is comprised of many signatures to make a signature scheme. Every signature is referenced as your OTS index or [One Time Signature](../../../../qrl/build/fundamentals/ots-keys) key index. 
