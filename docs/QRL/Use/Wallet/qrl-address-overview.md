...
slug: /qrl/use/wallet/qrl-address-overview
---
...
:::info 
For more information on how the public address is structured and what the bytes represent, see the [Address Scheme](../../../qrl/build/address/address-scheme) documentation
:::
...
A secure source of entropy is used to generate a private key, or seed, which is passed through a secure [_Pseudo-Random Function_ (PRF)](https://crypto.stanford.edu/pbc/notes/crypto/prf.html) to generate a set of pseudo-random keys which generate the Merkle tree consisting of many [OTS keys](../../../qrl/build/fundamentals/ots-keys)
