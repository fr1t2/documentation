...
slug: /qrl/tutorials/node/dual-node-host
---
...
It is assumed that you have a working installation of Ubuntu 20.04 and have followed the [guides for installing a mainnet node on Ubuntu](../../../qrl/use/node/installation).
...
:::tip
Check out all of the functions with `qrl --help` or see the [Node CLI Documentation](../../../qrl/use/node/node-cli#cli-help)
:::
